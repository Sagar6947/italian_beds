                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <?php
                                                    if(!empty($fetchrow['discounted_price'])){
                                                    
                                                    ?>
                                                    <td>$ <?php echo $fetchrow['discounted_price']; ?><br> <strike>$ <?php echo $fetchrow['price']; ?></strike> </td>
                                                    <?php
                                                    } else {
                                                    ?>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url() . 'admin_Dashboard/edit_variants/' . $fetchrow['id']; ?>" class="btn btn-info edit">Variants (<?= $varcount ?>)</a>
                                                    </td>
                                                    <td>
